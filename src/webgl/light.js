export default class Light {
  constructor(position, color) {
    ...
    this.amb_c0 = vec4.fromValues(color[0], color[1], color[2], 1.0);
    this.amb_k = 0.4;

    this.dif_c0 = vec4.fromValues(1.0, 1.0, 1.0, 1.0);
    this.dif_k = 0.5;
  ...
  createUniforms(gl, program){
    const posLoc = gl.getUniformLocation(program, "light_pos0");
    ...
    const difCLoc = gl.getUniformLocation(program, "light_dif_c0");
